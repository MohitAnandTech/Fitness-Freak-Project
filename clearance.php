    ...
    <div class="main">
		...
		<div class="menus">
			<div class="menu_container">
                <div id="menucase">
                  <div id="stylefour">
                    <ul>
					  ...
					  <li><a href="normal.php">Normal stock products</a></li>
                    </ul>
                  </div>
                </div>            
            </div>
                ...
                <hr>
				<?php 
				$getProducts=$db->query("select productID,name,price,image,brand,category from product where status='clearance'");
