		...
		<div class="menus">
			<div class="menu_container">
                <div id="menucase">
                  <div id="stylefour">
                    <ul>
                      <li><a href="coming.php">Products Coming Soon</a></li>
					  <li><a href="clearance.php">Clearance sale Products</a></li>
					  <li><a href="products.php">Normal stock products</a></li>
                    </ul>
                  </div>
                </div>            
            </div>
                ...
                <hr>
				<?php 
				$query="select productID from product where $search_type='$search_value'";
				$count=countValue($query,"productID");
				if($count>0){
					$fetchQuery="select productID,name,price,image,brand,category from product where $search_type='$search_value'";
					$getProducts=$db->query($fetchQuery);
				...
				<?php } 
					...
					echo "No records found matching your search criterial";
				}
				?>
